		...
		},
		{
			...
			args: args{
				...
				request: &idl.GetDataRequest{
					...
					DataDoi:       "ISCDTD20230906402800_image.viv.cn.",
					SignatureData: *IDL.NewSignatureDataWithSign("lob22xqwup.viv.cn.", string(testpkg.GetMockDataContent("/mock_data/user/alice/private.hex"))),
				},
			},
			want:    nil,
			wantErr: false,
